...
<body>
    ...
    <div class="table-product">
		...
		if(mysqli_num_rows($result3)>=1){
			...
			<td class="modify"><a name="edit" id="" class="bfix" href="show_doctors_profile_admin.php?DoctorID=<?php echo $row['DoctorID'] ?>" role="button">Show Profile</a></td>
                        <td class="delete"><a name="id" id="" class="bdelete" href="delete_doctors.php?DoctorID=<?php echo $row['DoctorID'] ?>" role="button">Delete</a></td>
                    </tr>
                <?php
                } }?>
            </tbody>
